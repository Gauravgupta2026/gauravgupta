    ...
    <Shell as="section" id="notes" wide className="pt-[80px] md:pt-[130px]">
      ...
      <div className="mt-[20px] md:mt-[32px]">
        {notes.map((note) => (
          ...
          >
            <div className="font-mono text-[10px] tracking-[0.12em] text-mute-3">
              ARTICLE
            </div>
            <div className="text-pretty text-[15px] tracking-[-0.01em] text-white md:text-[17px]">
              {note.title}
            </div>
            <div className="text-[13px] text-lilac md:text-[14px]">
              Read &rarr;
            </div>
          </Link>
        ))}
