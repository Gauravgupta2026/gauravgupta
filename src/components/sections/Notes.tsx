    ...
    <Shell as="section" id="notes" wide className="pt-[80px] md:pt-[130px]">
      ...
      <div className="mt-[20px] md:mt-[32px]">
        {notes.map((note) => (
          ...
          >
            <div className="font-mono text-[8px] tracking-[0.12em] text-mute-3">
              ARTICLE
            </div>
            <div className="text-pretty text-[12px] tracking-[-0.01em] text-white md:text-[14px]">
              {note.title}
            </div>
            <div className="text-[10px] text-lilac md:text-[11px]">
              Read &rarr;
            </div>
          </Link>
        ))}
