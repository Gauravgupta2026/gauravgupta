      ...
      {faqs.map((f, i) => {
        ...
        return (
          <div key={f.q} className="border-t border-border-2">
            ...
            >
              <span
                className={`text-pretty text-[14px] leading-[20px] tracking-[-0.01em] transition-colors duration-300 md:text-[19px] md:leading-[26px] ${
            ...
            >
              <div className="max-w-[720px] text-pretty pb-[14px] text-[12px] leading-[18px] text-mute-2 md:pb-[20px] md:text-[14px] md:leading-[23px]">
                {f.a}
              </div>
            </div>
          </div>
